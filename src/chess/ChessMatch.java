...
public class ChessMatch {
    ...
    public ChessPiece replacePromotedPiece(String type) {
        ...
        if(promoted == null) throw new IllegalStateException("There is no Piece to bem Promoted");
        ...
        //Testa possiveis checks após a promoção
    ...
    private void validateSourcePosition(Position position){
        ...
        if(!board.piece(position).isThereAnyPossibleMove()) {
            throw  new ChessException("There is no moves for this chosen piece");
        }
